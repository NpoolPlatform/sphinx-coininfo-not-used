    ...
    stage('Unit Tests') {
      ...
      steps {
        ...
        sh (returnStdout: false, script: '''
          ...
          kubectl -n kube-system exec mysql-0 -- mysql -h 127.0.0.1 -uroot -p$PASSWORD -P3306 -e "create database if not exists sphinx_coininfo;"
    ...
    stage('Generate docker image') {
      ...
      steps {
        sh(returnStdout: true, script: '''
          images=`docker images | grep entropypool | grep sphinx-coininfo | awk '{ print $3 }'`
