module github.com/NpoolPlatform/sphinx-coininfo
...
require (
	...
	github.com/NpoolPlatform/go-service-framework v0.0.0-20220413213108-5a09582419d3
	github.com/NpoolPlatform/message v0.0.0-20220412072110-19f5832bcaed
